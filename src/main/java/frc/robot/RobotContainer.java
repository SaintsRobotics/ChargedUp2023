...
public class RobotContainer {
    ...
    private void configureButtonBindings() {
        ...
        new POVButton(m_driverController, 0).onTrue(new AutoAlignCommand(m_robotDrive, Direction.kCenter));
        new POVButton(m_driverController, 90).onTrue(new AutoAlignCommand(m_robotDrive, Direction.kRight));
        new POVButton(m_driverController, 270).onTrue(new AutoAlignCommand(m_robotDrive, Direction.kLeft));
    }
