...
public class SwerveModule {
  ...
  public SwerveModulePosition getPosition() {
    ...
    return Robot.isReal()
        ? new SwerveModulePosition(m_driveEncoder.getDistance(), new Rotation2d(m_turningEncoder.getDistance()))
  ...
  public void setDesiredState(SwerveModuleState desiredState) {
    ...
    m_state = SwerveModuleState.optimize(desiredState, new Rotation2d(m_turningEncoder.getDistance()));

    // Calculate the drive output from the drive PID controller.
    final double driveOutput = m_drivePIDController.calculate(m_driveEncoder.getRate(), m_state.speedMetersPerSecond);
